...
#define IEEE802154_MAC_TX_INDIRECTQ_SIZE     (8)
#endif
...
/**
 * @brief Initialize IEEE 802.15.4 MAC with explicit radio type
 *
 * @param[in] mac       pointer to MAC descriptor
 * @param[in] cbs       callback set

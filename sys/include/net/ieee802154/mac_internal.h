...
{
    if (indirect_q->free_mask == 0) {return -1;}
...
static inline void ieee802154_indirectq_free_slot(ieee802154_mac_indirect_q_t *indirect_q, uint8_t slot)
{
...
static inline void ieee802154_mac_indirect_fp_update(ieee802154_mac_t *mac,
...
static inline void ieee802154_mac_handle_indirectq_auto_free(ieee802154_mac_t *mac,
...
static inline int ieee802154_mac_indirectq_get_slot(ieee802154_mac_indirect_q_t *indirect_q, const ieee802154_ext_addr_t *dst_addr)
{
                                                      ...
                                                      const void *dst_addr)
{
    *(uint8_t *)mac->cmd.iol_base = IEEE802154_CMD_DATA_REQ;
    ...
    ieee802154_mac_map_push(mac, IEEE802154_FCF_TYPE_MACCMD, dst_mode, dst_mode, dst_panid, dst_addr, &mac->cmd, &handle, true, false);
    return 0;
}

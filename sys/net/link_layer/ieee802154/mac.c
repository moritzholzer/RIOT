...
static const ieee802154_pib_attr_entry_t ieee802154_pib_attr[IEEE802154_PIB_ATTR_COUNT] = {
    ...
    [IEEE802154_PIB_COORD_SHORT_ADDRESS] = {
        ...
        .def=(ieee802154_pib_value_t){ .type=IEEE802154_PIB_TYPE_NUI16, .v.short_addr={.u16=0xFFFFu} },
        .min=(ieee802154_pib_value_t){ .type=IEEE802154_PIB_TYPE_NUI16, .v.short_addr={.u16=0} },
        .max=(ieee802154_pib_value_t){ .type=IEEE802154_PIB_TYPE_NUI16, .v.short_addr={.u16=0xFFFFu} }
    },
...
void ieee802154_pib_init(ieee802154_pib_t *pib)
{
    for (unsigned i = 0; i < (unsigned)IEEE802154_PIB_ATTR_COUNT; i++) {
        ...
        void *dst = ieee802154_pib_ptr(pib, e);
